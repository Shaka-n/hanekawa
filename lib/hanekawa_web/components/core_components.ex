defmodule HanekawaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HanekawaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HanekawaWeb.Gettext, "errors", msg, opts)
    end
  end
